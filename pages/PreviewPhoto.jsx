...
function PreviewPhoto() {
  ...
  try {
    ...
    await addDoc(libraryRef, {
      src: imageToSave,
      timestamp: serverTimestamp(),  // Optional: add timestamp
    });
    ...
    setShowConfirmBox(false);  // Hide confirmation box after save
  } catch (error) {
  ...
  useEffect(() => {
    if (frameMode === '4' && selectedFrame && capturedImages.length === 4) {
      ...
      frameImg.onload = () => {
        ...
        const positions = [
          { x: 66, y: 40,  w: 337, h: 138 },
          { x: 66, y: 185, w: 337, h: 138 },
          { x: 66, y: 331, w: 337, h: 138 },
          { x: 66, y: 476, w: 337, h: 138 },
        ];
